...
fig2 <- plot_ly(data_bf, x = ~year, y = data_bf$BONA_savana, name = "BONA", type = "scatter", mode = 'lines+markers', color = I("red"), opacity = 0.5, marker = list(size = data_bf$BONA_savana/100, color = "steelblue"))%>%
  ...
  layout(yaxis = list(title = "Savanna, grassland and shrubland fires C emissions (TgC/year)"),
...
test1%>%layout(annotations = list(
 list(x = 0.03 , y = 1.05, text = "Annual fire C emissions (TgC/year)", showarrow = F, xref='paper', yref='paper'),
 list(x = 0.88 , y = 1.05, text = "Savanna fires C emissions (TgC/year)", showarrow = F, xref='paper', yref='paper'))
)
...
fig3 <- plot_ly(data_bf, x = ~year, y = data_bf$BONA_boreal, name = "BONA", type = "scatter", mode = 'markers', 
  ...
  layout(yaxis = list(title = "Boreal forest fires C emissions (TgC/year)"),
         xaxis = list(title = ""), showlegend = FALSE)
...
fig4 <- plot_ly(data_bf, x = ~year, y = data_bf$BONA_temper, name = "BONA", type = "scatter",
  ...
  layout(yaxis = list(title = "Temperate forest fires C emissions (TgC/year)"),
...
test2%>%layout(annotations = list(
 list(x = 0.03 , y = 1.05, text = "Boreal forest fires C emissions (TgC/year)", showarrow = F, xref='paper', yref='paper'),
 list(x = 0.88 , y = 1.05, text = "Temperate forest fires C emissions (Tg/Cyear)", showarrow = F, xref='paper', yref='paper'))
)
...
test3%>%layout(annotations = list(
 ...
 list(x = 0.88 , y = 1.05, text = "Peat Fires C emissions (TgC/year)", showarrow = F, xref='paper', yref='paper'))
)
